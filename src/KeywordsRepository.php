...
use Reactor\Cache\Exceptions\ReservedCacheKeyPatternException;
...
class KeywordsRepository extends IRepository
{
	 ...
	 * @return $this
	 */
	public function mergeKeywords($keywords = array())
	{
	 ...
	 * @return $this
	 */
	public function overwriteKeywords($keywords = array())
	{
